...
""" To Run the file ( python -m bokeh serve --show Main.py) in the terminal   """
x_co = [-3.14,3.14]
y_co = [0,0]
x_co_1=[0,0]
y_co_1=[-10,10]
...
renderer3 = s1.asterisk(x="x", y="y", source=Conjugate, color='red', size=10)
renderer_4 = s1.circle(x='x', y='y', source=Conjugate2, color='blue', size=10)
